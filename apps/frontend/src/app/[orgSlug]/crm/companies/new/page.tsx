...
export default function NewCompanyPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (form.numberOfEmployees) payload.numberOfEmployees = parseInt(form.numberOfEmployees, 10);
      ...
      const company = await apiFetch(`/organizations/${orgSlug}/companies`, {
        method: 'POST',
        body: JSON.stringify(payload),
      });

      router.push(`/${orgSlug}/crm/companies/${company.id}`);
    } catch (err: any) {
    ...
    <div className="max-w-3xl mx-auto space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">Add a new company to your CRM</p>
        </div>
      </div>
