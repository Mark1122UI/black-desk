...
function ResetPasswordForm() {
  ...
  if (!token) {
    return (
      <div className="bg-white/80 dark:bg-zinc-900/80 backdrop-blur-xl border border-gray-100 dark:border-zinc-800 rounded-2xl shadow-xl p-8 space-y-6 text-center">
        <div className="flex justify-center text-red-500">
          <AlertCircle className="h-12 w-12" />
        </div>
        <h2 className="text-xl font-bold">Invalid Link</h2>
        <p className="text-sm text-gray-500 dark:text-zinc-400">
          This password reset link is invalid, incomplete, or expired.
        </p>
        <div className="pt-2">
          <Link
    ...
    <div className="bg-white/80 dark:bg-zinc-900/80 backdrop-blur-xl border border-gray-100 dark:border-zinc-800 rounded-2xl shadow-xl p-8 space-y-6">
      ...
      {success ? (
        <div className="space-y-4 text-center py-4 animate-in zoom-in-95 duration-200">
          ...
          <h2 className="text-lg font-semibold text-gray-900 dark:text-white">Password reset complete</h2>
          <p className="text-sm text-gray-500 dark:text-zinc-400">
      ...
      <div className="w-full max-w-md">
        ...
        <Suspense fallback={
          <div className="bg-white/80 dark:bg-zinc-900/80 backdrop-blur-xl border border-gray-100 dark:border-zinc-800 rounded-2xl shadow-xl p-8 space-y-6 text-center">
            ...
            <p className="text-sm text-gray-500">Loading reset credentials...</p>
          </div>
        }>
          <ResetPasswordForm />
        </Suspense>
